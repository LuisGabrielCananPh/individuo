...
<body>
    ...
    <table id="tab">
        ...
        <a href=form.html>
        <div id="div2a" >
            <br>novo por aqui?<br>clique aqui para cadastrar<br>
        </div>
        </a>
        
        <a href=form2.html>
        <div id="div2b" >
            <br>já possui conta né?<br>clique aqui para logar<br>
        </div></a>
        
        <a href=form3.html>
        <div id="div2c" >
            <br>quer entrar como anonimo?<br>clique aqui para apenas entrar<br>
        </div>
        </a>
    </div>
</td>
<td>
    <div id="divcapi">
        <img src="img/caipivar.png" id="capi">
    </div>
</td>
    </tr>
    </table>  
