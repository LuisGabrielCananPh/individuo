    ...
    <div id="div2f"><br>
        ...
        <main>
            <form id="formulario-cadastro" action="form.php" method="post">
              <fieldset id="borda">
                <legend id="title">Antes de comprar, primeiro vamos criar uma conta</legend>
                ...
                <div class="secao-contato">
                  ...
                  <input type="text" id="cpf" name="cpf" placeholder="000.000.000-00" inputmode="numeric" pattern="[0-9]{3}\.[0-9]{3}\.[0-9]{3}\-[0-9]{2}" required>
                    <br>
                  <label for="cep">CEP:</label>
                  <input type="text" id="cep" name="cep" placeholder="00000-000" inputmode="numeric" pattern="[0-9]{5}-[0-9]{3}" required>
                  <br>
                ...
                <div class="secao-senha">
                  ...
                  <br>
                  <span class="senha-info">
                    <i id="mostrarSenha" class="fas fa-eye"></i>
                    <p>Mostrar Senha</p>
                  </span>
                </div>
